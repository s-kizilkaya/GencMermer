      ...
      <GridContainer justifyContent="center">
        <GridItem xs={12} sm={12} md={12}>
          ...
          <h5 className={classes.description}>
            Genç Mermer olarak, 2000 yılından bu yana mermer sektöründe kaliteli
            çözümler sunma konusundaki kararlılığımızla tanınmaktayız. Mermer ve
            doğal taş işleme konusundaki uzmanlığımızla, her projede müşteri
            memnuniyetini en üst düzeyde tutmayı hedefliyoruz. Deneyimli
            ekibimiz ve modern teknolojimizle, doğal taşın estetiğini ve
            dayanıklılığını yaşam alanlarınıza taşıyoruz.
          </h5>
        </GridItem>
      </GridContainer>
      <GridContainer>
