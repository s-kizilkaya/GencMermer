  ...
  return (
    <div className={classes.section}>
      <GridContainer justifyContent="center">
        <GridItem xs={12} sm={12} md={8}>
          ...
          <h5 className={classes.description}>
            Aşağıdaki haritayı kullanarak konumumuzu görebilir ve bize kolayca
            ulaşabilirsiniz.
          </h5>
        </GridItem>
      </GridContainer>
      ...
      <GridContainer justifyContent="center">
        <GridItem xs={12} sm={12} md={8}>
          <h5 className={classes.description}>
            Toplu taşıma ile ulaşım: Tramvay Baksan durağından inip, 5 dakikalık
            yürüme mesafesindeyiz.
            <br />
            Özel araç ile ulaşım: İşyerimizin yakınında otopark alanı
            bulunmaktadır.
          </h5>
        </GridItem>
      </GridContainer>
